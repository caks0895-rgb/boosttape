...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-yqnaEoUa.mjs");
...
var manifest = { "2feaec2eed45c2aecd2f03b1d83c78806d0219c8931dbbeba7fad8b3a45c7185": {
	functionName: "getLandingData_createServerFn_handler",
	importer: () => import("./sample.functions-DlvrimS6.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DBQ0KJNw.mjs").then((n) => n.t),
